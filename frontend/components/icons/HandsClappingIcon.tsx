interface HandsClappingIconProps {
  width?: number;
  height?: number;
  fill?: string;
}

const HandsClappingIcon: React.FC<HandsClappingIconProps> = ({
  width = 24,
  height = 24,
  fill,
}) => {
