...
class Asset(Model):
    ...
    asset_photos = fields.ManyToManyField(
        "models.AssetPhotos", related_name="asset_photos"
    )
    address = fields.ForeignKeyField(
        "models.Address", related_name="asset_address", null=True
    )
...
class AssetTransaction(Model):
    ...
    transaction_type = fields.ForeignKeyField(
        "models.AssetTransactionType", related_name="asset_transaction_type"
    )
    asset = fields.ForeignKeyField(
        "models.Asset", related_name="asset_transaction_history"
    )
